...
void	sl_ending_screen(t_data *data, int f)
{
	...
	else if (data->end == 2)
	{
		...
		{
			if (data->key == KEY_A)
				mlx_put_image_to_window(data->mlx, data->window, data->p[29 + data->wk].img, ((data->y + 1) * 32) - (6 * 2), data->x * 32);
			else if (data->key == KEY_S)
				mlx_put_image_to_window(data->mlx, data->window, data->p[(29 + (data->pf / 2)) + data->wk].img, data->y * 32, ((data->x - 1) * 32) + (6 * 2));
		...
		if (data->wk <= 2 && data->wk != 1)
		{
			if (data->u[data->x][data->y].mv == 1)
				mlx_put_image_to_window(data->mlx, data->window, data->m[28 + data->wk].img, (data->y * 32) - 12, data->x * 32);
			else if (data->u[data->x][data->y].mv == 2)
				mlx_put_image_to_window(data->mlx, data->window, data->m[(28 + (data->u[data->x + 1][data->y].pf / 2)) + data->wk].img, data->y * 32, (data->x * 32) + 12);
	...
	else if (data->end == 3 && data->wk <= 5 && data->u[data->x][data->y].mv == 4)
	{
		...
		if (data->wk < 2)
			...
			mlx_put_image_to_window(data->mlx, data->window, data->p[29 + data->wk].img, ((data->y + 1) * 32) - (6 * 3), data->x * 32);
		else if (data->key == KEY_S)
			mlx_put_image_to_window(data->mlx, data->window, data->p[(29 + (data->pf / 2)) + data->wk].img, data->y * 32, ((data->x - 1) * 32) + (6 * 3));
		else if (data->key == KEY_D)
			mlx_put_image_to_window(data->mlx, data->window, data->p[29 + data->wk].img, ((data->y - 1) * 32) + (6 * 3), data->x * 32);
		else if (data->key == KEY_W)
			mlx_put_image_to_window(data->mlx, data->window, data->p[(29 + (data->pf / 2)) + data->wk].img, data->y * 32, ((data->x + 1) * 32) - (6 * 3));
		mlx_put_image_to_window(data->mlx, data->window, data->m[29 + data->wk + (data->u[data->x][data->y].pf / 2)].img, data->y * 32, data->x * 32);
		if (data->wk == 5)
			data->map[data->x][data->y] = '0';
	}
	else if (data->end == 3 && data->wk <= 5 && data->u[data->x][data->y].mv != 4)
	{
		...
		{
			if (data->key == KEY_A)
				mlx_put_image_to_window(data->mlx, data->window, data->p[29 + data->wk].img, ((data->y + 1) * 32) - 20, data->x * 32);
			else if (data->key == KEY_S)
				mlx_put_image_to_window(data->mlx, data->window, data->p[(29 + (data->pf / 2)) + data->wk].img, data->y * 32, ((data->x - 1) * 32) + 20);
			else if (data->key == KEY_D)
				mlx_put_image_to_window(data->mlx, data->window, data->p[29 + data->wk].img, ((data->y - 1) * 32) + 20, data->x * 32);
			else if (data->key == KEY_W)
				mlx_put_image_to_window(data->mlx, data->window, data->p[(29 + (data->pf / 2)) + data->wk].img, data->y * 32, ((data->x + 1) * 32) - 20);	
		...
		{
			if (data->u[data->x][data->y].mv == 1)
				mlx_put_image_to_window(data->mlx, data->window, data->m[33 + data->wk].img, ((data->y + 1) * 32) - 20, data->x * 32);
			else if (data->u[data->x][data->y].mv == 2)
				mlx_put_image_to_window(data->mlx, data->window, data->m[(28 + (data->u[data->x][data->y].pf / 2)) + data->wk].img, data->y * 32, ((data->x - 1) * 32) + 20);
			else if (data->u[data->x][data->y].mv == 3)
				 mlx_put_image_to_window(data->mlx, data->window, data->m[28 + data->wk].img, ((data->y - 1) * 32) + 20, data->x * 32);
			else if (data->u[data->x][data->y].mv == 0)
				mlx_put_image_to_window(data->mlx, data->window, data->m[(28 + (data->u[data->x][data->y].pf / 2)) + data->wk].img, data->y * 32, ((data->x + 1) * 32) - 20);
		}
		else
